...
Start /Wait PowerShell -NoL -C Start-AutopilotOOBE -Title 'EDUBS PoC Autopilot Register' -Hidden AssignedUser,AssignedComputerName -AddToGroup sg-GYMWG -Grouptag Mittelschulen -Assign -PostAction SysprepReboot
'@
