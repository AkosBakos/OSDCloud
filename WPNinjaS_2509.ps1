...
Date			By			Comments
----------		---			----------------------------------------------------------
23.09.2025		Akos Bakos	Script created
...
#=======================================================================
$Global:WPNinjaS   = $null
$Global:WPNinjaS   = [ordered]@{
    Development     = [bool]$false
    TestGroup       = [bool]$false
}
Write-SectionHeader "WPNinjaS variables"
Write-Host ($Global:WPNinjaS | Out-String)
...
#$AssignedComputerName = "NB-$lastFourChars"
...
# Device assignment
if ($Global:WPNinjaS.TestGroup -eq $true){
...
#region Development
if ($Global:WPNinjaS.Development -eq $true){
    #================================================
...
if ($Global:WPNinjaS.Development -eq $false){
